...
class SalesDashboard(QWidget):
    ...
    def _submit_invoice(self):
        ...
        if mode == "عميل":
            ...
            # Build elegant HTML receipt for products
            rows_html = ""
            for _, name, price, qty in items:
                rows_html += f"""
                <tr>
            ...
            <body>
                <div class="container">
                    ...
                    <div class="meta">
                        التاريخ: {ts.strftime('%Y-%m-%d %I:%M %p')} &nbsp;&nbsp; • &nbsp;&nbsp; المشتري: {customer_name}
                    </div>
                    <table>
                        <thead>
                            <tr>
                    ...
                    <div class="totals">
                        <div class="line"><span>الإجمالي قبل الخصم</span><span>{format_amount(total)} ج.م</span></div>
                        <div class="line"><span>الخصم</span><span>{discount_percent}%</span></div>
                        <div class="line final"><span>الإجمالي بعد الخصم</span><span>{format_amount(total * (1 - discount_percent/100.0))} ج.م</span></div>
                    </div>
